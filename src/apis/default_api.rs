...
pub async fn clone_voice_from_clip(configuration: &configuration::Configuration, params: CloneVoiceFromClipParams) -> Result<models::VoiceEmbedding, Error<CloneVoiceFromClipError>> {
    ...
    local_var_req_builder = local_var_req_builder.header("Cartesia-Version", cartesia_version.to_string());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CloneVoiceFromClipError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn tts_bytes_post(configuration: &configuration::Configuration, params: TtsBytesPostParams) -> Result<std::path::PathBuf, Error<TtsBytesPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TtsBytesPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn tts_sse_post(configuration: &configuration::Configuration, params: TtsSsePostParams) -> Result<models::TtsSsePost200Response, Error<TtsSsePostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TtsSsePostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn voices_clone_url_post(configuration: &configuration::Configuration, params: VoicesCloneUrlPostParams) -> Result<models::VoiceEmbedding, Error<VoicesCloneUrlPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VoicesCloneUrlPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn voices_get(configuration: &configuration::Configuration, params: VoicesGetParams) -> Result<Vec<models::Voice>, Error<VoicesGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VoicesGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn voices_id_delete(configuration: &configuration::Configuration, params: VoicesIdDeleteParams) -> Result<(), Error<VoicesIdDeleteError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/voices/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VoicesIdDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn voices_id_get(configuration: &configuration::Configuration, params: VoicesIdGetParams) -> Result<models::Voice, Error<VoicesIdGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VoicesIdGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn voices_post(configuration: &configuration::Configuration, params: VoicesPostParams) -> Result<models::Voice, Error<VoicesPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VoicesPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
